...
[[Recruiter|Recruiters]] need to know who is on the blacklist to:
...
An associate transitions to **Black** status in the [[Associate Status Indicator]] due to:
...
- **Resolution in favor of the hotel:** the associate transitions to **Black** ([[Core/Modules/Blacklist|Blacklist]]).
