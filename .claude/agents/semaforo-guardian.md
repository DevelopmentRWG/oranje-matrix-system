...
`Business Developer (BD)`, `Business Developer Coordinator (BDC)`, `Reclutadora`, `Manager de Reclutamiento`, `Inspector`, `Coordinador`, `Hotel/Colaborador del Gerente del Hotel`, `Hotel/Manager del Hotel (GH)`, `Hotel/GHC`.
