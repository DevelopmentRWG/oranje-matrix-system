...
`Business Developer (BD)`, `Business Developer Coordinator (BDC)`, `Reclutadora`, `Manager de Reclutamiento`, `QA Inspector`, `Hotel/Solicitante del Hotel`, `Hotel/Manager del Hotel (GH)`, `Hotel/GHC`.
