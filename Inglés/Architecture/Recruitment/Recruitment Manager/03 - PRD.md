...
## PRD – RECRUITMENT MANAGER

**Personnel Management System · Manager Role**
...
| ----------------------- | ------------------------------------------------------------------------------------------- |
| **PRD ID**              | PRD-RECL-04                                                                                 |
| **User Story**          | HU-RECL-04                                                                                  |
| **Department**          | Recruitment                                                                                 |
| **Functionality**       | Supervise the department, manage the Blacklist, resolve escalations and handle special cases |
| **Main Actor**          | Recruitment Manager                                                                         |
| **Device**              | Web – Desktop                                                                               |
