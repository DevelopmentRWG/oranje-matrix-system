...
| 2 — Alta en la app          | Colaborador completa Posición, Nivel de inglés, Nivel de experiencia, Tipo de transporte, Modalidad (obligatorios); SSN, ITIN y documento de SSN/ITIN son opcionales; sin SSN ni ITIN → retención 16% reembolsable activada automáticamente (ver [[Deducciones]]) | Colaborador     |
