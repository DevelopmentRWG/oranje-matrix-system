...
**Historia:**
Cuando una incidencia afecta la relación comercial con el hotel (queja recurrente, riesgo de pérdida de cliente, conflicto serio con el Manager de Área), el Manager de Reclutamiento la escala al Business Developer (BD) o Business Developer Coordinator (BDC) del módulo Onboarding-Hotel para que tomen la conversación comercial.
