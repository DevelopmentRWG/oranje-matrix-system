...
| ------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Blanco        | Pre-asignación                        | El colaborador subió sus datos en la app pero aún no ha sido validado por la Reclutadora. Estado pre-validación: sin accesos habilitados, sin asignación.                          |
...
| Verde fuerte  | Disponible                            | Disponible para asignación. Aplica a: (1) colaborador recién validado por la Reclutadora (Fase 2 aprobada, pertenece a Oranje); (2) colaborador reincorporado tras fin de asignación fija, disputa a su favor o alta médica. |
...
- **Blanco → Verde fuerte**: cuando la Reclutadora aprueba la validación (RF-08). El colaborador queda habilitado en el Pool, con accesos propagados, disponible para asignación.
...
- **Verde fuerte → Café**: la [[Reclutadora]] o el [[Reclutamiento/Líder de Grupo de Reclutadoras|Líder de Grupo]] lo asigna temporalmente (→ Café). Se define la duración (días asignados) al momento de la asignación. El estado se cierra automáticamente al vencer esos días; al cerrarse, vuelve a `Verde fuerte`.
...
- **Café → Verde fuerte / Amarillo (cancelación manual)**: la [[Reclutadora]] o el [[Reclutamiento/Líder de Grupo de Reclutadoras|Líder de Grupo]] puede cancelar manualmente la asignación temporal antes de que venzan los días. Al cancelar, el colaborador regresa de inmediato a su estado previo (`Verde fuerte` o `Amarillo`) y queda liberado del Schedule del hotel.
