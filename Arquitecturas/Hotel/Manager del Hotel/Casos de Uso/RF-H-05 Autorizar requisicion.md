...
**Historia:**
El Supervisor crea una requisición y la envía al Manager del Hotel para autorización. El Manager revisa que la requisición esté completa, justificada y correcta. Al autorizarla, la requisición se envía automáticamente a la bandeja de Reclutamiento (modelo Self-Pick), donde Reclutadoras y Líderes de Grupo pueden tomarla libremente. La autorización es la **capa de seguridad** del sistema (regla RR-H-02): garantiza que Oranje solo recibe requisiciones validadas por el hotel.

**Criterios de aceptación:**
Solo el Manager del Hotel puede autorizar (RR-H-02). La requisición debe tener al menos 1 posición registrada (RR-H-03). Al autorizar, el sistema calcula automáticamente la urgencia por posición (>120h Verde, 72-120h Amarillo, <72h Rojo), asigna el Inspector según zona, refleja las posiciones en el Schedule semanal y envía la requisición a la bandeja de Reclutamiento — todo en menos de 30s. Notifica al Supervisor del cambio de estado.
