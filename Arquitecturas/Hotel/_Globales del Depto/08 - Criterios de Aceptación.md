...
| **AC-H-03** | El sistema bloquea la autorización si el rol no es Manager del Hotel, mostrando: *"Solo el gerente del hotel puede autorizar la requisición"* (RR-H-02). |
...
| **AC-H-11** | Solo el Manager del Hotel puede generar / renovar el QR del Timesheet (RR-H-09).                                                                |
| **AC-H-12** | El QR generado es válido inmediatamente; los colaboradores pueden ponchar al instante.                                                          |
| **AC-H-13** | Solo el Manager del Hotel puede reportar a un colaborador (Rojo); la acción notifica al Inspector y inicia investigación (RR-H-10).            |
| **AC-H-14** | Manager del Hotel y Supervisor pueden poner en Stand-by (Rosa); el colaborador queda sin Schedule ni Timesheet (RR-H-11).                       |
...
| **AC-H-19** | Toda corrección de ponche por el Manager del Hotel queda en log auditable con autor, fecha y motivo obligatorio (RNF-H-03).                    |
...
| **AC-H-22** | La interfaz es responsive: Manager del Hotel y Manager General desde 7"; Supervisor desde 5" (mobile, RNF-H-04).                                |
...
| **AC-H-25** | Al rechazar una requisición, las observaciones del Manager del Hotel son visibles para el Supervisor en el detalle.                            |
