...
| Requisiciones         | Ver vista global del hotel                           | —           | Sin acceso (solo Manager del Hotel y Manager General)             |
...
| Requisiciones         | Enviar a autorización                                | ➕ Crear     | Envía al Manager del Hotel                                        |
...
| Schedule              | Editar Schedule                                      | —           | Sin acceso (solo Manager del Hotel)                               |
...
| Timesheet             | Corregir ponche                                      | —           | Sin acceso (solo Manager del Hotel)                               |
...
| Mi Personal           | Poner colaborador en Stand-by (Rosa)                 | 📝 C · E    | Compartido con Manager del Hotel (RR-H-11)                        |
| Mi Personal           | Reportar colaborador (Rojo)                          | —           | Sin acceso (solo Manager del Hotel — RR-H-10)                     |
