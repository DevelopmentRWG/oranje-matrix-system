...
**Historia:**
Cuando un colaborador comete una falta grave (mala conducta, robo, conflicto, falta justificada), el Manager de Área lo **reporta** desde el módulo Mi Personal. Esta acción es **exclusiva del Manager de Área** (regla RR-H-10 — el Supervisor NO puede reportar). El colaborador pasa al estado **Rojo** en el Semáforo del Colaborador y se inicia automáticamente la investigación del Inspector de zona.

**Criterios de aceptación:**
Solo el Manager de Área puede reportar (RR-H-10). El motivo es obligatorio (catálogo: Falta grave / Mala conducta / Robo / Conflicto / Otro). La descripción debe tener al menos 50 caracteres para iniciar la investigación. Evidencia opcional (PDF/JPG/PNG, máx. 10 MB). El colaborador debe estar asignado al depto del Manager. Notifica al Inspector de zona en menos de 1 min. Queda en log auditable.
