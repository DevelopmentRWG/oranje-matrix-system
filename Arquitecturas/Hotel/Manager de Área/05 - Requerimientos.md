...
tags:
  ...
  - rol/manager-de-area
aliases:
  - Requerimientos Manager de Área
---
...
| ---------- | ---------------------------------------------------- | --------- |
| RF-H-01    | **Crear requisición** *(NUEVO — compartido)*         | 🔴 Alta   |
...
| RR-H-03    | Posición mínima para autorizar                       | 🔴 Alta   |
| RR-H-09    | Generación de QR (M.Área + M.General)                | 🔴 Alta   |
| RR-H-10    | Reporte de colaborador (Rojo) compartido (3 roles)   | 🔴 Alta   |
| RR-H-11    | Stand-by (Rosa) compartido (3 roles)                 | 🔴 Alta   |
| RR-H-15    | Indicador de Lunch Extendido restringido             | 🔴 Alta   |
| RR-H-16    | Deducción de Lunch (mínimo 30 min)                   | 🔴 Alta   |
| RR-H-17    | Jornada y semana laboral                             | 🔴 Alta   |
| RR-H-19    | Reporte de accidentes (3 roles)                      | 🔴 Alta   |
