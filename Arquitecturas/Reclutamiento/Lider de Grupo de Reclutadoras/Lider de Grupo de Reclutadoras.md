...
SIDEBAR
   ...
   ├─ MIS REQUISICIONES        (con Distribuir / Tomar para mí)
   ├─ MI GRUPO DE RECLUTADORAS ← exclusivo del Líder
...
- Buscar en Pool
- Consultar Blacklist
- Distribuir requisición a Reclutadora
- Generar reporte
...
## 📋 Módulo MIS REQUISICIONES

### Lista por estado del [[Semáforo de Requisición]]
- 🟢 Autorizadas (recibidas, sin distribuir)
- 🟡 En proceso (distribuidas a una Reclutadora del grupo)
- 🔵 Cubiertas (100% — cerradas bien)
...
- Reclutadora asignada (si aplica)
- Colaboradores ya asignados

### Acciones (opción C — mixta)
- **🎯 Distribuir a Reclutadora del grupo** *(acción principal del Líder)*
- **👤 Tomar para mí** *(caso especial: trabajar la requisición personalmente como Reclutadora)*
- Reasignar a otra Reclutadora
- Asignar colaborador (cuando trabaja la requisición directamente)
- Marcar como cubierta
- Marcar como parcial
- Reportar problema (escala al Manager)

> [!important]
> Esta es la diferencia clave vs la Reclutadora: el Líder puede **decidir** si distribuye la requisición a alguien de su grupo o si la trabaja él/ella mismo. La Reclutadora solo recibe y trabaja.
